Pod::Spec.new do |s|
    ...
    s.homepage     = "https://github.com/yourusername/react-native-audio-chunking"
    s.license      = { :type => "MIT", :file => "../LICENSE" }
    s.author       = { "Isaac Grey" => "isaac.j.grey@gmail.com" }
    s.platform     = :ios, "11.0"
    s.source       = { :git => "https://github.com/yourusername/react-native-audio-chunking.git", :tag => "#{s.version}" }
